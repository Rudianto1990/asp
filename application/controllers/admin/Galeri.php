	...
	function simpan_galeri(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_galeri->simpan_galeri($judul,$isi,$album,$user_id,$user_nama,$gambar);
						// 	echo '<pre>';
				        //    var_dump($this);die();
				        //    echo '</pre>';
	...
	function update_galeri(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$user_id=$p['pengguna_id'];
							$user_nama=$p['pengguna_nama'];
							$this->m_galeri->update_galeri($galeri_id,$judul,$isi,$album,$user_id,$user_nama,$gambar);
	                    ...
	                    redirect('admin/galeri');
							...
							$user_id=$p['pengguna_id'];
							$user_nama=$p['pengguna_nama'];
							$this->m_galeri->update_galeri_tanpa_img($galeri_id,$judul,$isi,$album,$user_id,$user_nama);
							echo $this->session->set_flashdata('msg','info');
							redirect('admin/galeri');
	            } 
