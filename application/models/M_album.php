...
class M_album extends CI_Model{
	...
	function get_all_jumlah_album(){
		$hsl=$this->db->query("SELECT COUNT(b.galeri_album_id) as jumlah_album, A.*,B.* FROM tbl_album A left join tbl_galeri B ON(A.album_id=b.galeri_album_id)");
    }
