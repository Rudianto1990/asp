    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'admin/services/add_services'?>"><i class="fa fa-thumb-tack"></i> Add Portfolio</a></li>
            <li><a href="<?php echo base_url().'admin/services'?>"><i class="fa fa-list"></i> Services List</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
		...
		<form action="<?php echo base_url().'admin/services/simpan_services'?>" method="post" enctype="multipart/form-data">
