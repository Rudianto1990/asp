...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="#">TECT OF PANGANDARAN</a>.</strong> All rights reserved.
  </footer>
                    ...
                    <div class="modal-body">       
                                ...
                                <input type="hidden" value="<?php echo $album_cover;?>" name="gambar">
                                  <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nama Album</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnama_album" class="form-control" value="<?php echo $album_nama;?>" id="inputUserName"  required>
                                        </div>
                                    </div>
