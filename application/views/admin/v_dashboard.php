...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url().'assets/dist/css/skins/skin-purple.css'?>">
  <?php
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'admin/timku'?>"><i class="fa fa-clone"></i>TIM ASP</a></li>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-green"><i class="fa fa-internet-explorer"></i></span>
              <?php 
                    $query=$this->db->query("SELECT * FROM tbl_pengunjung WHERE pengunjung_perangkat='Spartan'");
                    $jml=$query->num_rows();
              ?>
            <div class="info-box-content">
              <span class="info-box-text">Internet Explorer </span>
              <span class="info-box-number"><?php echo $jml;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
