        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/galeri/add_galeri'?>"><span class="fa fa-plus"></span> Add Gallery</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $i) :
                                ...
                                $galeri_descripsi=$i['galeri_descripsi'];
                  ...
                  <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'admin/galeri/update_galeri'.$galeri_id;?>"><span class="fa fa-pencil"></span></a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Hapus Galleri</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/galleri/hapus_galeri'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
							       <input type="hidden" name="kode" value="<?php echo $galeri_id;?>"/> 
                     <input type="hidden" value="<?php echo $galeri_gambar;?>" name="gambar">
                            <p>Apakah Anda yakin mau menghapus Galleri <b><?php echo $galeri_judul;?></b> ?</p>
  ...
  $(function () {
    ...
    <?php if($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Galleri Berhasil disimpan ke database.",
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Galleri berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
