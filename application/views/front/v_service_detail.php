...
<body>
    ...
    <main class="site-main page-main">
        <div class="container">
            <div class="row">
            <?php	foreach ($pely->result() as $row) :	?>
                <section class="page col-sm-8">
                    <!-- <h2 class="page-title"><?php //echo $row->galeri_judul;?></h2> -->
                    <h1 style="margin-bottom:0px;"><a href="#"><?php echo $row->service_judul;?></a></h1>
						<small><em>Posted by: <?php echo $row->service_author;?> |  | Tanggal Post : <?php echo date("d-m-Y H:i:s",strtotime($row->service_tanggal)); ?> </em></small>
							<figure>
								<img src="<?php echo base_url().'assets/images/'.$row->service_image;?>" alt="" class="img-responsive">
							</figure> <br/>  

                    <div class="entry">
                        <p><?php echo $row->service_deskripsi;?></p>
