	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>"><span>ASP</span></a></h1>
				<nav role="navigation">
					<ul>
  ...
  <div class="container">
    <div class="row"><br/>
      ...
      <div class="col-md-4">
		...
		<h3><a href="<?php echo base_url().'gallery/'.$row->galeri_id;?>"><?php echo $row->galeri_judul;?></a></h3>
            <span><?php //echo $row->galeri_tanggal.' | '.$galeri_author;?></span>
