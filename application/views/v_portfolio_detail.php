...
<html class="no-js">
	...
	<meta name="author" content="TECH OF PANGANDARAN" />
	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">ASP<span>.</span></a></h1>
				<nav role="navigation">
					<ul>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Enjoy the Portfolio</h2>
							   <p class="fh5co-lead"> Awesome source code by <a href="#" target="_blank">TECH OF PANGANDARAN</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
	...
	<div class="fh5co-pricing">
		<div class="container">
			...
			<div class="row">
						...
						<small><em>Posted by: <?php echo $author;?> | <?php echo $date;?> | Kategori: <?php echo $kategori;?> | <?php echo $views;?> kali dibaca | Rating: <?php echo $rating;?></em></small>
							...
							<?php echo $isi;?>
								...
								<div class="alert alert-success">
									...
									<a class="btn btn-sm" href="<?php echo base_url().'portfolio/good/'.$b['tulisan_slug'];?>" title="Good"><i class="fa fa-smile-o fa-2x"></i></a>
									<a class="btn btn-sm" href="<?php echo base_url().'portfolio/like/'.$b['tulisan_slug'];?>" title="Like"><i class="fa fa-thumbs-o-up fa-2x"></i></a>
									<a class="btn btn-sm" href="<?php echo base_url().'portfolio/love/'.$b['tulisan_slug'];?>" title="Love"><i class="fa fa-heart-o fa-2x"></i></a>
									<a class="btn btn-sm" href="<?php echo base_url().'portfolio/genius/'.$b['tulisan_slug'];?>" title="Genius"><i class="fa fa-lightbulb-o fa-2x"></i></a>
								</div>
								<?php endif;?>
						<h4>Share:</h4>
						<div>
					...
					<div class="col-md-4">
						<form class="search_form" action="<?php echo base_url().'portfolio/search'?>" method="post">
						...
						<?php foreach($kat->result() as $i):?>
							<li><a href="<?php echo base_url().'portfolio/kategori/'.$i->kategori_id;?>"><?php echo $i->kategori_nama.' ('.$i->jml.')';?></a></li>
						<?php endforeach;?>
						</ul>
						<br/>
						<h4>POST POPULER</h4>
